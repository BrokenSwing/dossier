...
export const loginAtom = StorageRpc.runtime.fn<{ username: string; password: string; totpCode: string }>()(
...
export const unlockAtom = StorageRpc.runtime.fn<{ password: string }>()(
  ({ password }, get) =>
    Effect.gen(function* () {
