...
import { CryptoError, deriveAuthKey, deriveKek, deriveMasterKey, generateKdfParams, wrapDek } from "../lib/crypto.js";
...
export const isChangePasswordFormValid = (form: ChangePasswordForm): boolean =>
  form.oldPassword.length > 0 && form.newPassword.length > 0 && form.newPassword === form.confirmPassword;

export const changePasswordAtom = StorageRpc.runtime.fn<ChangePasswordForm>()(({ oldPassword, newPassword }, get) => {
